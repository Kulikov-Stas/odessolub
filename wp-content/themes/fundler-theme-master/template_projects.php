...
<div class="bigcontainer4">
    <div class="container">
                ...
                <div class="homepage_featured_content">
                    ...
                    <div class="homepage_featured_content_right">
                        ...
                        <div class="top_info_line_box_button" id="homepage_featured_button">
                            <a href="<?php the_permalink(); ?>">смотреть проект</a>
                        </div>
                    </div>
                </div>
            </div>
        ...
        <div class="homepage_browse_top">Откройте для себя проекты</div>
        <div class="homepage_browse_content">
        <div class="homepage_browse_content_title"><p>Топовые</p><span>Категории</span></div>
        ...
        <div class="homepage_browse_search"><form method="get" id="searchform" action="<?php echo home_url(); ?>/"><div class="browse_search_input"><input type="text" size="" name="s" id="s" value="искать проект..." onFocus="if(this.value==this.defaultValue)this.value='';" onBlur="if(this.value=='')this.value=this.defaultValue;"/></div><div class="browse_search_submit"><input type="submit" id="searchsubmit" value="" class="browse_search_button" /></div></form></div>
        </div>
        </div>
        
        
        <div class="subpage_line">
        <div class="projects_list_line"><ul>
        <?php
                            ...
                            <div class="project_list_box_dataline_right">
                                <div class="project_list_box_dataline_right_top">
                                    ...
                                    <div class="project_list_box_dataline_right_line2">
                                        <p>
                                            Осталось:
                                        </p><span><?php echo $campaign->days_remaining(); ?> дня</span>
                                    </div>
                                </div>
                            </div>
                        </div>
