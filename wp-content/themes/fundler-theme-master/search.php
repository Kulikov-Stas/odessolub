...
<div class="blog_post">
						<h1 class="archive-title text-center"><span><?php _e('Результаты поиска:', 'fundler'); ?></span> <?php echo esc_attr(get_search_query()); ?></h1>
						...
						<?php endwhile; ?>
							...
							<?php else : ?>
                                 <div class="page_404">
									...
									<div class="content_404_search"><form method="get" id="searchform" action="<?php echo home_url(); ?>/"><div class="content_404_search_input"><input type="text" size="" name="s" id="s" value="искать..." onFocus="if(this.value==this.defaultValue)this.value='';" onBlur="if(this.value=='')this.value=this.defaultValue;"/></div><div class="content_404_search_submit"><input type="submit" id="searchsubmit" value="" class="content_404_search_button" /></div></form></div>
